...
/* Intro: Cover steht, zoomt in den Läufer (Mitte) und blendet aus. */
.intro { position: fixed; top: 0; left: 0; right: 0; bottom: 0; z-index: 200; background: #0D0F13; }
.intro img { width: 100%; height: 100%; object-fit: cover; display: block; transform-origin: 50% 38%; animation: introZoom 1.4s ease-in forwards; }
@keyframes introZoom { 0% { transform: scale(1); opacity: 1; } 65% { transform: scale(1.35); opacity: 1; } 100% { transform: scale(1.55); opacity: 0; } }
`;