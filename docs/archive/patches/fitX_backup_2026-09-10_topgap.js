...
const EXERCISES = [
  { name: "Bankdrücken", emoji: "🏋️", alias: ["bench press", "bankdruecken"] },
  { name: "Schrägbankdrücken", emoji: "🏋️", alias: ["incline bench press", "schraegbank"] },
  { name: "Kurzhantel-Bankdrücken", emoji: "🏋️", alias: ["dumbbell bench press", "kh bankdrücken"] },
  { name: "Butterfly (Pec Deck)", emoji: "🦋", alias: ["butterfly", "pec deck", "pecdeck", "fly", "fliegende", "seated fly", "chest fly", "brust fly"] },
  { name: "Kabelzug-Fliegende", emoji: "🦋", alias: ["cable fly", "cable crossover", "crossover", "kabel fliegende"] },
  { name: "Liegestütze", emoji: "🔥", alias: ["push up", "pushup", "push-up", "liegestuetz"] },
  { name: "Dips", emoji: "🪑", alias: ["dips", "barren", "chest dips", "trizeps dips"] },
  { name: "Kreuzheben", emoji: "🏋️‍♂️", alias: ["deadlift"] },
  { name: "Rumänisches Kreuzheben", emoji: "🦵", alias: ["romanian deadlift", "rdl", "rumaenisches kreuzheben"] },
  { name: "Klimmzüge", emoji: "💪", alias: ["pull up", "pullup", "pull-up", "klimmzug"] },
  { name: "Latzug", emoji: "💪", alias: ["lat pulldown", "latziehen", "latzug breit", "latzug eng"] },
  { name: "Rudern", emoji: "🚣", alias: ["row", "seated row", "sitzend rudern"] },
  { name: "Langhantelrudern", emoji: "🚣", alias: ["barbell row", "bent over row", "vorgebeugtes rudern"] },
  { name: "Kurzhantelrudern", emoji: "🚣", alias: ["dumbbell row", "one arm row", "einarmiges rudern"] },
  { name: "Kabelrudern", emoji: "🚣", alias: ["cable row", "kabelzug rudern"] },
  { name: "Face Pulls", emoji: "🪢", alias: ["facepull", "face pull"] },
  { name: "Shrugs", emoji: "🏋️", alias: ["shrugs", "nackenziehen", "traps", "schulterheben"] },
  { name: "Rückenstrecker", emoji: "🧘", alias: ["back extension", "hyperextension", "rueckenstrecker"] },
  { name: "Good Mornings", emoji: "🏋️", alias: ["good morning"] },
  { name: "Schulterdrücken", emoji: "🙆", alias: ["shoulder press", "overhead press", "military press", "schulterpresse"] },
  { name: "Arnold Press", emoji: "🙆", alias: ["arnold"] },
  { name: "Seitheben", emoji: "🙆", alias: ["lateral raise", "side raise", "seitenheben"] },
  { name: "Frontheben", emoji: "🙆", alias: ["front raise"] },
  { name: "Reverse Butterfly", emoji: "🦋", alias: ["reverse fly", "rear delt", "reverse butterfly", "hintere schulter"] },
  { name: "Kniebeugen", emoji: "🦵", alias: ["squat", "back squat"] },
  { name: "Frontkniebeugen", emoji: "🦵", alias: ["front squat"] },
  { name: "Beinpresse", emoji: "🦵", alias: ["leg press"] },
  { name: "Ausfallschritte", emoji: "🦵", alias: ["lunge", "lunges"] },
  { name: "Bulgarische Split Squats", emoji: "🦵", alias: ["bulgarian", "split squat"] },
  { name: "Beinstrecker", emoji: "🦵", alias: ["leg extension", "quadrizeps maschine"] },
  { name: "Beinbeuger", emoji: "🦵", alias: ["leg curl", "hamstring curl", "beinbeuger liegend", "beinbeuger sitzend"] },
  { name: "Adduktoren-Maschine", emoji: "🦵", alias: ["adductor", "adduktion", "innenschenkel"] },
  { name: "Abduktoren-Maschine", emoji: "🦵", alias: ["abductor", "abduktion", "aussenschenkel"] },
  { name: "Wadenheben", emoji: "🦵", alias: ["calf raise", "calves", "waden", "wadenheben stehend", "wadenheben sitzend"] },
  { name: "Hip Thrust", emoji: "🍑", alias: ["hipthrust", "glute bridge", "beckenheben", "po"] },
  { name: "Wandsitzen", emoji: "🪑", alias: ["wall sit"] },
  { name: "Bizepscurls", emoji: "💪", alias: ["biceps curl", "bicep curl", "curls", "langhantelcurls"] },
  { name: "Hammercurls", emoji: "🔨", alias: ["hammer curl"] },
  { name: "Konzentrationscurls", emoji: "💪", alias: ["concentration curl"] },
  { name: "SZ-Curls", emoji: "💪", alias: ["ez bar curl", "sz", "sz curls"] },
  { name: "Trizepsdrücken", emoji: "💪", alias: ["triceps", "pushdown", "trizeps", "kabelzug trizeps"] },
  { name: "Trizepsdrücken über Kopf", emoji: "💪", alias: ["overhead triceps", "overhead extension", "french press"] },
  { name: "Kickbacks", emoji: "💪", alias: ["kickback", "trizeps kickback"] },
  { name: "Plank", emoji: "🧘", alias: ["plank", "unterarmstütz", "unterarmstuetz"] },
  { name: "Side Plank", emoji: "↔️", alias: ["side plank", "seitstütz", "seitstuetz"] },
  { name: "Bauchpresse", emoji: "🧘", alias: ["crunch", "crunches", "sit up", "situp"] },
  { name: "Beinheben", emoji: "🦶", alias: ["leg raise", "knee raise", "hängendes beinheben", "haengendes beinheben"] },
  { name: "Russian Twist", emoji: "🌀", alias: ["russian"] },
  { name: "Hollow Hold", emoji: "🍌", alias: ["hollow"] },
  { name: "Mountain Climbers", emoji: "🏔️", alias: ["mountain climber", "bergsteiger"] },
  { name: "Burpees", emoji: "🔥", alias: ["burpee"] },
  { name: "Kettlebell Swing", emoji: "🔔", alias: ["kettlebell"] },
  { name: "Laufband", emoji: "🏃", alias: ["running", "laufen", "jogging", "treadmill", "joggen"] },
  { name: "Rudergerät", emoji: "🚣", alias: ["rowing machine", "ergometer rudern", "concept2"] },
  { name: "Radfahren", emoji: "🚴", alias: ["cycling", "bike", "fahrrad", "ergometer", "spinning"] },
  { name: "Crosstrainer", emoji: "🏃", alias: ["elliptical", "cross trainer"] },
  { name: "Treppensteiger", emoji: "🪜", alias: ["stairmaster", "stair climber", "stepper"] },
  { name: "Seilspringen", emoji: "🪢", alias: ["jump rope", "skipping", "seil", "rope skipping"] },
  { name: "Schwimmen", emoji: "🏊", alias: ["swimming"] },
  { name: "Dehnen", emoji: "🧘", alias: ["stretching", "mobility", "dehnen", "yoga"] },
];
