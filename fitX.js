...
// Große Offline-DB (Geräte, Kabel, Kurzhanteln, Bodyweight, Cardio) + englische Aliase,
// damit z.B. Butterfly, Beinbeuger oder Face Pulls sofort gefunden werden.
const PLAN_CATS = ["Alle", "Brust", "Rücken", "Schultern", "Beine", "Arme", "Bauch", "Cardio"];
const EXERCISES = [
  { name: "Bankdrücken", emoji: "🏋️", cat: "Brust", alias: ["bench press", "bankdruecken"] },
  { name: "Schrägbankdrücken", emoji: "🏋️", cat: "Brust", alias: ["incline bench press", "schraegbank"] },
  { name: "Kurzhantel-Bankdrücken", emoji: "🏋️", cat: "Brust", alias: ["dumbbell bench press", "kh bankdrücken"] },
  { name: "Butterfly (Pec Deck)", emoji: "🦋", cat: "Brust", alias: ["butterfly", "pec deck", "pecdeck", "fly", "fliegende", "seated fly", "chest fly", "brust fly"] },
  { name: "Kabelzug-Fliegende", emoji: "🦋", cat: "Brust", alias: ["cable fly", "cable crossover", "crossover", "kabel fliegende"] },
  { name: "Liegestütze", emoji: "🔥", cat: "Brust", alias: ["push up", "pushup", "push-up", "liegestuetz"] },
  { name: "Dips", emoji: "🪑", cat: "Brust", alias: ["dips", "barren", "chest dips", "trizeps dips"] },
  { name: "Kreuzheben", emoji: "🏋️‍♂️", cat: "Rücken", alias: ["deadlift"] },
  { name: "Rumänisches Kreuzheben", emoji: "🦵", cat: "Beine", alias: ["romanian deadlift", "rdl", "rumaenisches kreuzheben"] },
  { name: "Klimmzüge", emoji: "💪", cat: "Rücken", alias: ["pull up", "pullup", "pull-up", "klimmzug"] },
  { name: "Latzug", emoji: "💪", cat: "Rücken", alias: ["lat pulldown", "latziehen", "latzug breit", "latzug eng"] },
  { name: "Rudern", emoji: "🚣", cat: "Rücken", alias: ["row", "seated row", "sitzend rudern"] },
  { name: "Langhantelrudern", emoji: "🚣", cat: "Rücken", alias: ["barbell row", "bent over row", "vorgebeugtes rudern"] },
  { name: "Kurzhantelrudern", emoji: "🚣", cat: "Rücken", alias: ["dumbbell row", "one arm row", "einarmiges rudern"] },
  { name: "Kabelrudern", emoji: "🚣", cat: "Rücken", alias: ["cable row", "kabelzug rudern"] },
  { name: "Face Pulls", emoji: "🪢", cat: "Rücken", alias: ["facepull", "face pull"] },
  { name: "Shrugs", emoji: "🏋️", cat: "Rücken", alias: ["shrugs", "nackenziehen", "traps", "schulterheben"] },
  { name: "Rückenstrecker", emoji: "🧘", cat: "Rücken", alias: ["back extension", "hyperextension", "rueckenstrecker"] },
  { name: "Good Mornings", emoji: "🏋️", cat: "Rücken", alias: ["good morning"] },
  { name: "Schulterdrücken", emoji: "🙆", cat: "Schultern", alias: ["shoulder press", "overhead press", "military press", "schulterpresse"] },
  { name: "Arnold Press", emoji: "🙆", cat: "Schultern", alias: ["arnold"] },
  { name: "Seitheben", emoji: "🙆", cat: "Schultern", alias: ["lateral raise", "side raise", "seitenheben"] },
  { name: "Frontheben", emoji: "🙆", cat: "Schultern", alias: ["front raise"] },
  { name: "Reverse Butterfly", emoji: "🦋", cat: "Schultern", alias: ["reverse fly", "rear delt", "reverse butterfly", "hintere schulter"] },
  { name: "Kniebeugen", emoji: "🦵", cat: "Beine", alias: ["squat", "back squat"] },
  { name: "Frontkniebeugen", emoji: "🦵", cat: "Beine", alias: ["front squat"] },
  { name: "Beinpresse", emoji: "🦵", cat: "Beine", alias: ["leg press"] },
  { name: "Ausfallschritte", emoji: "🦵", cat: "Beine", alias: ["lunge", "lunges"] },
  { name: "Bulgarische Split Squats", emoji: "🦵", cat: "Beine", alias: ["bulgarian", "split squat"] },
  { name: "Beinstrecker", emoji: "🦵", cat: "Beine", alias: ["leg extension", "quadrizeps maschine"] },
  { name: "Beinbeuger", emoji: "🦵", cat: "Beine", alias: ["leg curl", "hamstring curl", "beinbeuger liegend", "beinbeuger sitzend"] },
  { name: "Adduktoren-Maschine", emoji: "🦵", cat: "Beine", alias: ["adductor", "adduktion", "innenschenkel"] },
  { name: "Abduktoren-Maschine", emoji: "🦵", cat: "Beine", alias: ["abductor", "abduktion", "aussenschenkel"] },
  { name: "Wadenheben", emoji: "🦵", cat: "Beine", alias: ["calf raise", "calves", "waden", "wadenheben stehend", "wadenheben sitzend"] },
  { name: "Hip Thrust", emoji: "🍑", cat: "Beine", alias: ["hipthrust", "glute bridge", "beckenheben", "po"] },
  { name: "Wandsitzen", emoji: "🪑", cat: "Beine", alias: ["wall sit"] },
  { name: "Bizepscurls", emoji: "💪", cat: "Arme", alias: ["biceps curl", "bicep curl", "curls", "langhantelcurls"] },
  { name: "Hammercurls", emoji: "🔨", cat: "Arme", alias: ["hammer curl"] },
  { name: "Konzentrationscurls", emoji: "💪", cat: "Arme", alias: ["concentration curl"] },
  { name: "SZ-Curls", emoji: "💪", cat: "Arme", alias: ["ez bar curl", "sz", "sz curls"] },
  { name: "Trizepsdrücken", emoji: "💪", cat: "Arme", alias: ["triceps", "pushdown", "trizeps", "kabelzug trizeps"] },
  { name: "Trizepsdrücken über Kopf", emoji: "💪", cat: "Arme", alias: ["overhead triceps", "overhead extension", "french press"] },
  { name: "Kickbacks", emoji: "💪", cat: "Arme", alias: ["kickback", "trizeps kickback"] },
  { name: "Plank", emoji: "🧘", cat: "Bauch", alias: ["plank", "unterarmstütz", "unterarmstuetz"] },
  { name: "Side Plank", emoji: "↔️", cat: "Bauch", alias: ["side plank", "seitstütz", "seitstuetz"] },
  { name: "Bauchpresse", emoji: "🧘", cat: "Bauch", alias: ["crunch", "crunches", "sit up", "situp"] },
  { name: "Beinheben", emoji: "🦶", cat: "Bauch", alias: ["leg raise", "knee raise", "hängendes beinheben", "haengendes beinheben"] },
  { name: "Russian Twist", emoji: "🌀", cat: "Bauch", alias: ["russian"] },
  { name: "Hollow Hold", emoji: "🍌", cat: "Bauch", alias: ["hollow"] },
  { name: "Mountain Climbers", emoji: "🏔️", cat: "Bauch", alias: ["mountain climber", "bergsteiger"] },
  { name: "Burpees", emoji: "🔥", cat: "Cardio", alias: ["burpee"] },
  { name: "Kettlebell Swing", emoji: "🔔", cat: "Cardio", alias: ["kettlebell"] },
  { name: "Laufband", emoji: "🏃", cat: "Cardio", alias: ["running", "laufen", "jogging", "treadmill", "joggen"] },
  { name: "Rudergerät", emoji: "🚣", cat: "Cardio", alias: ["rowing machine", "ergometer rudern", "concept2"] },
  { name: "Radfahren", emoji: "🚴", cat: "Cardio", alias: ["cycling", "bike", "fahrrad", "ergometer", "spinning"] },
  { name: "Crosstrainer", emoji: "🏃", cat: "Cardio", alias: ["elliptical", "cross trainer"] },
  { name: "Treppensteiger", emoji: "🪜", cat: "Cardio", alias: ["stairmaster", "stair climber", "stepper"] },
  { name: "Seilspringen", emoji: "🪢", cat: "Cardio", alias: ["jump rope", "skipping", "seil", "rope skipping"] },
  { name: "Schwimmen", emoji: "🏊", cat: "Cardio", alias: ["swimming"] },
  { name: "Dehnen", emoji: "🧘", cat: "Cardio", alias: ["stretching", "mobility", "dehnen", "yoga"] },
];
function exerciseMatch(e, q) {
  if (!e || !q) return false;
  if (e.name.toLowerCase().includes(q)) return true;
  return (e.alias || []).some((a) => a.toLowerCase().includes(q));
}
function matchExercises(query) {
  const q = (query || "").trim().toLowerCase();
  if (!q) return [];
  const direct = EXERCISES.filter((e) => e.name.toLowerCase().includes(q));
  const viaAlias = EXERCISES.filter((e) => !direct.includes(e) && exerciseMatch(e, q));
  return [...direct, ...viaAlias].slice(0, 6);
}
function exerciseEmoji(name) {
  const q = (name || "").trim().toLowerCase();
  const f = EXERCISES.find((e) => e.name.toLowerCase() === q || (e.alias || []).some((a) => a.toLowerCase() === q));
  return f ? f.emoji : "🏋️";
}
...
export default function App() {
  ...
  // Intro: Cover zoomen (in den Läufer) und ausblenden – HTML-Splash übernimmt nahtlos.
  // Deko-Ebenen (teure Blur-Animationen) pausieren währenddessen per .intro-on → kein Hängen.
  useEffect(() => {
    try { document.querySelector("#splash")?.remove(); } catch {}
  ...
  useEffect(() => {
    (async () => {
      ...
      const nuClean = (nu && typeof nu === "object") ? { ...nu } : { height: "", weight: "", bodyFat: "", rate: "0.5", age: "", gender: "", goal: "halten", activity: "normal", dailyGoal: 2200 };
      if (nuClean.build === "schlank") nuClean.build = "duenn"; // Legacy: Schlank -> Dünn
      setNutrition(nuClean);
      setLoaded(true);
    })();
  }, []);
  ...
  return (
    <div className={"app" + (intro ? " intro-on" : "")} style={cssVars(t)}>
      <style>{css}</style>
      ...
      {intro && (
        <div className="intro" aria-hidden="true">
          <img src="splash.png" alt="" onError={() => setIntro(false)} />
        </div>
      )}
      ...
      <aside className={"drawer" + (menuOpen ? " open" : "")} aria-hidden={!menuOpen} aria-label="Menü">
        ...
        <div className="drawer-cap">Bereiche</div>
        {[
          ["home", "Start", Home],
          ...
          <button key={id} className={"drawer-item" + (tab === id ? " active" : "")} onClick={() => { setTab(id); setMenuOpen(false); }}>
            <span className="drawer-ico"><Icon size={19} /></span><span>{label}</span>
          </button>
        ))}
      </aside>
      <div className="screen">
        ...
        {tab === "home" && (
          <HomeTab
            ...
            meals={meals} nutrition={nutrition} checkins={checkins} water={water}
          />
        )}
        {tab === "training" && (
          <TrainingTab
        ...
        {tab === "ernaehrung" && (
          <FoodTab meals={meals} setMeals={setMeals} nutrition={nutrition} setNutrition={setNutrition} profile={profile} water={water} setWater={setWater} onEditBody={() => setTab("profil")} />
        )}
        {tab === "erinnerungen" && (
          <ReminderTab
        ...
        {tab === "profil" && (
          <ProfilTab
            ...
            checkins={checkins} workouts={workouts} skills={skills} nutrition={nutrition} setNutrition={setNutrition}
...
// ---------- Helpers ----------
// Navigation läuft nur über den Drawer oben (keine Bottom-Tabbar mehr).
...
function MacroRing({ pct, label, sub, color }) {
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      <svg className="macro-ring" viewBox="0 0 100 100" role="img" aria-label={`${label} ${p}%`}>
        ...
        <circle className="val" cx="50" cy="50" r={r} strokeDasharray={`${(p / 100) * c} ${c}`} style={color ? { stroke: color } : undefined} />
      </svg>
      <div>
...
function HomeTab({ nextEvent, goTo, meals, nutrition, checkins, water }) {
  ...
  const waterGoal = calcWaterGoal(nutrition);
  const todayWater = (water || []).filter((x) => x && dateKey(x.ts) === todayKey).reduce((a, c) => a + (Number(c.ml) || 0), 0);
  const waterPct = waterGoal > 0 ? Math.min(100, Math.round((todayWater / waterGoal) * 100)) : 0;
  ...
  const macros = [
    ...
    { label: "Kohlenhydrate", val: sumMacro("carbs"), target: targets.carbs },
    ...
    <div className="pad home-cover">
      ...
      <div className="cover-card card-in section-card" onClick={() => goTo("ernaehrung")} role="button" tabIndex={0}
        ...
        <div className="ring-row">
          ...
          <MacroRing pct={waterPct} label="Wasser" sub={`${todayWater} / ${waterGoal} ml`} color="var(--accent2)" />
        </div>
        <div className="macro-rows" style={{ marginTop: 8 }}>
          {macros.map((r) => (
      ...
      <div className="quick-grid">
        ...
        <button className="quick-btn primary" onClick={() => goTo("ernaehrung")}>+ Essen</button>
        <button className="quick-btn primary" onClick={() => goTo("ziele")}>{checked ? "Ziele ansehen" : "Einchecken"}</button>
      </div>
    </div>
  );
}
...
function TrainingTab({ workouts, setWorkouts, plans, setPlans, sharedPlans, persistSharedPlans, profile, restDays, setRestDays }) {
  ...
  const [planCat, setPlanCat] = useState("Alle");
  const [customEx, setCustomEx] = useState("");
  const PLAN_EMOJIS = ["🔥", "💪", "🦵", "🏋️", "🏃", "🧘", "🚴", "🚣"];
  const planQ = planQuery.trim().toLowerCase();
  const planFiltered = EXERCISES.filter((e) => (planCat === "Alle" || e.cat === planCat) && (!planQ || exerciseMatch(e, planQ)));
  const addCustomEx = () => {
    const v = customEx.trim();
    if (!v) return;
    setPlanExercises((cur) => (cur.includes(v) ? cur : [...cur, v]));
    setCustomEx("");
  };
  const searchPlanOnline = () => {
    const q = (planQuery.trim() || "Krafttraining") + " Übung Ausführung";
    try { window.open("https://www.google.com/search?q=" + encodeURIComponent(q), "_blank"); } catch {}
  };

  const suggestions = matchExercises(name);
  // Online-Fallback wie bei Google: Ausführung/Varianten im Browser nachschauen (Namen frei eintippbar).
  const searchExerciseOnline = () => {
    const q = name.trim();
    if (!q) return;
    try {
      window.open("https://www.google.com/search?q=" + encodeURIComponent(q + " Übung Ausführung"), "_blank");
    } catch {}
  };
  ...
  const savePlan = () => {
    ...
    setPlanQuery(""); setPlanCat("Alle"); setCustomEx("");
  };
  const removePlan = (id) => {
    ...
    <div className="pad">
        ...
        <div className="form-card card-in">
          ...
          {name.trim() && (
            <div className="set-row">
              <button className="link-btn" onClick={searchExerciseOnline}>🌍 Übung bei Google nachschauen</button>
            </div>
          )}
          {name.trim() && suggestions.length === 0 && (
            <div className="row-sub">Nicht dabei? Einfach eintippen und speichern – geht auch ohne Treffer.</div>
          )}
          {sets.map((s, i) => (
      ...
      {planCreating && (
        <div className="form-card card-in">
          ...
          <input
            className="input" placeholder="🔍 Übung suchen (deutsch oder englisch) …" value={planQuery}
            onChange={(e) => setPlanQuery(e.target.value)}
            onKeyDown={(e) => { if (e.key === "Escape") setPlanQuery(""); }}
          />
          <div className="day-picker" style={{ flexWrap: "nowrap", overflowX: "auto", paddingBottom: 4 }}>
            {PLAN_CATS.map((c) => (
              <button key={c} className={"day-chip" + (planCat === c ? " active" : "")} onClick={() => setPlanCat(c)} style={{ flexShrink: 0 }}>{c}</button>
            ))}
          </div>
          <div className="pick-list">
            {planFiltered.map((e) => {
              const sel = planExercises.includes(e.name);
              return (
                <button key={e.name} className={"pick-item" + (sel ? " active" : "")} onClick={() => toggleExerciseInPlan(e.name)} aria-pressed={sel}>
                  <span className="pick-check">{sel ? <Check size={14} /> : null}</span>
                  <span style={{ flex: 1 }}>{e.emoji} {e.name}</span>
                  <span className="row-sub">{e.cat}</span>
                </button>
              );
            })}
            {planFiltered.length === 0 && (
              <div className="empty-hint">Nichts gefunden – unten als eigene Übung hinzufügen oder online schauen.</div>
            )}
          </div>
          <div className="set-row">
            <button className="link-btn" onClick={searchPlanOnline}>🌍 Ausführung bei Google</button>
          </div>
          <div className="set-row">
            <input
              className="input" placeholder="➕ Eigene Übung (Name)" value={customEx}
              onChange={(e) => setCustomEx(e.target.value)}
              onKeyDown={(e) => { if (e.key === "Enter") addCustomEx(); }}
            />
            <button className="icon-btn" onClick={addCustomEx} aria-label="Eigene Übung hinzufügen"><Plus size={16} /></button>
          </div>
          {planExercises.length > 0 && (
            <div className="day-picker">
              {planExercises.map((n) => (
                <button key={n} className="day-chip active" onClick={() => toggleExerciseInPlan(n)} title="Entfernen" aria-label={`${n} entfernen`}>
                  {exerciseEmoji(n)} {n} <X size={12} />
                </button>
              ))}
            </div>
          )}
          <button className="primary-btn" onClick={savePlan} disabled={!planName.trim() || !planExercises.length}><Check size={16} /> Plan speichern ({planExercises.length})</button>
        </div>
      )}
...
// Körperbau statt KFA-Raten: kaum einer kennt seinen Fettanteil.
// Kräftig = stämmig/mit Bauch (hoher KFA), Muskuloes = trainiert (niedriger KFA).
const BUILD_LABELS = { duenn: "Dünn", normal: "Normal", muskuloes: "Muskulös", kraeftig: "Kräftig" };
// Grobe KFA-Schätzung (%) aus Körperbau + Geschlecht, nur für Katch-McArdle-Fallback.
function estimateBodyFat(build, gender) {
  const b = build === "schlank" ? "duenn" : build; // Legacy-Wert aus Vorgängerversion
  const table = {
    weiblich: { duenn: 20, normal: 27, muskuloes: 22, kraeftig: 35 },
    maennlich: { duenn: 12, normal: 18, muskuloes: 13, kraeftig: 26 },
  };
  const row = table[gender] || { duenn: 16, normal: 22, muskuloes: 17, kraeftig: 30 };
  return row[b] ?? null;
}
...
function calcDailyGoal(nutrition, profile) {
  ...
  // Körperbau als KFA-Schätzung, falls kein KFA eingetragen (kaum einer kennt seinen Anteil).
  let kfaEff = kfaValid ? kfa : null, kfaEstimated = false;
  if (kfaEff == null && nu.build) {
    const est = estimateBodyFat(nu.build, gender);
    if (Number.isFinite(est)) { kfaEff = est; kfaEstimated = true; }
  }
  let bmr, method;
  if (kfaEff != null) {
    const lbm = w * (1 - kfaEff / 100);
    bmr = 370 + 21.6 * lbm;
    method = kfaEstimated ? "Katch-McArdle (KFA geschätzt)" : "Katch-McArdle";
  } else {
...
// Wasserziel (ml): gespeichertes Ziel gewinnt, sonst 35 ml/kg, sonst 2000 ml Fallback.
function calcWaterGoal(nutrition) {
  const nu = nutrition || {};
  const explicit = Math.round(Number(nu.waterGoal));
  if (Number.isFinite(explicit) && explicit > 0) return Math.min(10000, explicit);
  const w = parseNum(nu.weight);
  if (w > 0) return Math.round(w * 35);
  return 2000;
}
// Rechner wie bei kcal: 35 ml/kg + Aktivitäts-Bonus, auf 50 ml gerundet. null ohne Gewicht.
function recommendWaterGoal(nutrition) {
  const nu = nutrition || {};
  const w = parseNum(nu.weight);
  if (!(w > 0)) return null;
  const bonus = { ruhig: 0, normal: 250, aktiv: 500, "sehr aktiv": 750, profi: 1000 }[nu.activity] ?? 250;
  return Math.round((w * 35 + bonus) / 50) * 50;
}
...
function NutritionProfile({ nutrition, setNutrition, profile }) {
  ...
  // Ein Rechner für alles: Kalorienziel + Wasserziel (35 ml/kg + Aktivität) in einem Schritt.
  const autoGoal = () => {
    ...
    const patch = { dailyGoal: g.value };
    const wv = recommendWaterGoal(draft);
    if (wv) patch.waterGoal = wv;
    setDraft((d) => ({ ...d, ...patch }));
    setCalcInfo(`Empfohlen: ${g.value} kcal/Tag (${g.method}, Verbrauch ~${g.tdee} kcal${g.delta ? `, ${g.delta > 0 ? "+" : ""}${g.delta}` : ""}).${wv ? ` Wasserziel: ${wv} ml/Tag gleich mit berechnet.` : " Wasserziel: erst Gewicht eintragen."}${g.warn ? " Hinweis: " + g.warn : ""}`);
  };
  ...
  if (!editing) {
    ...
    return (
      <div className="name-pill">
        <span>{nutrition.height || "–"} cm · {nutrition.weight || "–"} kg{nutrition.bodyFat ? ` · KFA ${nutrition.bodyFat}%` : (nutrition.build ? ` · ${BUILD_LABELS[nutrition.build] || nutrition.build}` : "")} · {act ? act.label : "Normal"} · Ziel: {GOAL_LABELS[nutrition.goal] || nutrition.goal} · {nutrition.dailyGoal} kcal/Tag</span>
  ...
  return (
    <div className="form-card card-in">
      ...
      <div className="row-sub">KFA unbekannt? Wähle deinen Körperbau – wir schätzen für die Berechnung.</div>
      <div className="day-picker">
        {Object.entries(BUILD_LABELS).map(([id, label]) => (
          <button key={id} className={"day-chip" + ((draft.build || "") === id ? " active" : "")} onClick={() => setDraft({ ...draft, build: draft.build === id ? "" : id })}>{label}</button>
        ))}
      </div>
      <div className="day-picker">
    ...
    <div className="stat-card wide card-in" style={{ marginTop: 8 }}>
      <div className="stat-head">
        <div>
          ...
          <div className="stat-label">Wasser heute</div>
        </div>
      ...
      <div className="row-sub">Ziel wird beim Tagesziel-Rechner (oben) gleich mit berechnet.</div>
      ...
      {todayList.slice(0, 5).map((x) => (
        <div key={x.id} className="row-card card-in" style={{ marginTop: 6 }}>
          <div style={{ flex: 1 }}>
            <div className="row-sub">{new Date(x.ts).toLocaleTimeString("de-DE", { hour: "2-digit", minute: "2-digit" })} · {x.label ? `${x.label} · ` : ""}{x.ml} ml</div>
          </div>
...
// Körperdaten werden nur im Profil gepflegt – Ernährung zeigt sie lesend und
// aktualisiert kcal/Protein & Co. automatisch nach dem Speichern im Profil.
function BodySummary({ nutrition, onEdit }) {
  const act = ACTIVITY_LEVELS.find((a) => a.id === nutrition.activity);
  if (!(nutrition.height || nutrition.weight)) {
    return (
      <div className="dashed-box">
        Noch keine Körperdaten. <button className="link-btn" onClick={onEdit}>Im Profil eintragen →</button>
      </div>
    );
  }
  return (
    <div className="name-pill">
      <span>{nutrition.height || "–"} cm · {nutrition.weight || "–"} kg{nutrition.bodyFat ? ` · KFA ${nutrition.bodyFat}%` : (nutrition.build ? ` · ${BUILD_LABELS[nutrition.build] || nutrition.build}` : "")} · {act ? act.label : "Normal"} · Ziel: {GOAL_LABELS[nutrition.goal] || nutrition.goal} · {nutrition.dailyGoal} kcal/Tag</span>
      <button className="icon-btn-ghost" onClick={onEdit} aria-label="Körperdaten im Profil ändern"><Pencil size={13} /></button>
    </div>
  );
}

function FoodTab({ meals, setMeals, nutrition, setNutrition, profile, water, setWater, onEditBody }) {
  ...
  const saveCalcMeal = () => {
    ...
    // Getränke (ml) zählen gleichzeitig als Flüssigkeit (z.B. Cola, Milch, Saft).
    if (calcUnit === "ml") {
      setWater((prev) => [{ id: uid(), ts: Date.now(), ml: Math.round(amountNum), label: calcFood.name }, ...(Array.isArray(prev) ? prev : [])]);
    }
  ...
  return (
    <div className="pad">
      ...
      <BodySummary nutrition={nutrition || {}} onEdit={onEditBody} />
...
function ProfilTab({ profile, setProfile, checkins, workouts, skills, nutrition, setNutrition, theme, setTheme }) {
  const p = profile || {};
  ...
  const resetAll = () => {
    try { if (!window.confirm("Wirklich alle Daten löschen?")) return; } catch { return; }
    try { if (!window.confirm("Endgültig bestätigen: Streak, Workouts, alles weg?")) return; } catch { return; }
    try {
      Object.keys(localStorage).filter((k) => k.indexOf("fitness:") === 0).forEach((k) => localStorage.removeItem(k));
    } catch {}
    try {
      const bridge = window.AndroidBridge;
      if (bridge && typeof bridge.syncReminders === "function") bridge.syncReminders("[]");
    } catch {}
  ...
  return (
    <div className="pad">
      ...
      <div className="form-card card-in">
        ...
        <div className="row-sub">Hier – und nur hier – liegen deine Daten. Die anderen Bereiche nutzen sie nur lesend.</div>
        <input
        ...
        <div className="day-picker">
          {Object.entries(GENDER_LABELS).map(([id, label]) => (
            <button
              ...
              aria-pressed={p.gender === id}
            >{label}</button>
          ))}
        </div>
        <div className="row-sub">Alter + Geschlecht fließen in die Tagesziel-Berechnung ein (Ernährung).</div>
      </div>
      <div className="section-title">Körper & Ziel</div>
      <NutritionProfile nutrition={nutrition} setNutrition={setNutrition} profile={profile} />
      <div className="form-card card-in">
        <div className="section-title" style={{ marginTop: 0 }}>Darstellung</div>
        <div className="set-row">
          <button className={"day-chip" + (theme === "light" ? " active" : "")} onClick={() => setTheme("light")} aria-pressed={theme === "light"}><Sun size={13} style={{ verticalAlign: "-2px" }} /> Hell</button>
          <button className={"day-chip" + (theme === "dark" ? " active" : "")} onClick={() => setTheme("dark")} aria-pressed={theme === "dark"}><Moon size={13} style={{ verticalAlign: "-2px" }} /> Dunkel</button>
        </div>
      </div>
      <div className="form-card card-in">
        <div className="section-title" style={{ marginTop: 0 }}>Daten</div>
        <div className="row-sub">Alle lokal gespeicherten Daten (Workouts, Mahlzeiten, Check-ins, Einstellungen) entfernen.</div>
        <button className="primary-btn" style={{ background: "var(--danger)" }} onClick={resetAll}><Trash2 size={15} /> Alle Daten löschen</button>
      </div>
    </div>
  );
}
...
body { background: #0D0F13; background: var(--bg); color: var(--text); overflow-x: hidden; }
.app { min-height: 100vh; background: var(--bg); color: var(--text); display: flex; flex-direction: column; max-width: 480px; margin: 0 auto; position: relative; padding-bottom: env(safe-area-inset-bottom, 0px); }
.statusbar { display: none; }
.blob { position: fixed; border-radius: 50%; filter: blur(70px); pointer-events: none; z-index: 0; will-change: transform; transform: translateZ(0); }
...
.topbar { display: flex; align-items: center; justify-content: space-between; padding: 10px 20px 16px; z-index: 10; position: relative; }
...
.screen { flex: 1; padding-bottom: 24px; z-index: 1; }
.pad { padding: 0 12px; }
...
.pick-list { display: flex; flex-direction: column; gap: 6px; max-height: 230px; overflow-y: auto; padding: 2px; }
.pick-item { display: flex; align-items: center; gap: 10px; width: 100%; text-align: left; background: var(--bg-input); border: 1px solid var(--border); color: var(--text); padding: 10px 12px; border-radius: 12px; font-size: 0.85rem; font-weight: 600; cursor: pointer; min-height: 44px; }
.pick-item.active { border-color: var(--accent); }
.pick-check { width: 22px; height: 22px; border-radius: 8px; border: 1px solid var(--border-strong); display: flex; align-items: center; justify-content: center; background: var(--bg); flex-shrink: 0; color: transparent; }
.pick-item.active .pick-check { background: var(--accent); border-color: transparent; color: #fff; }
...
.hero-row .streak-pill { margin-top: 0; flex-shrink: 0; white-space: nowrap; }
.hero-row .hero-big { margin: 6px 0; }
...
.backdrop { position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.6); z-index: 90; }
.drawer { position: fixed; top: 0; left: 0; bottom: 0; width: 280px; max-width: 84vw; z-index: 100; display: flex; flex-direction: column; gap: 4px; padding: 14px; background: var(--bg); color: var(--text); border-right: 1px solid var(--border-strong); box-shadow: var(--shadow); transform: translateX(-105%); transition: transform 0.25s ease; overflow-y: auto; }
.drawer.open { transform: none; }
.drawer-head { display: flex; align-items: center; justify-content: space-between; margin-bottom: 4px; padding-bottom: 10px; border-bottom: 1px solid var(--border); }
.drawer-cap { font-size: 0.68rem; font-weight: 800; letter-spacing: 0.08em; text-transform: uppercase; color: var(--text-faint); margin: 8px 4px 2px 4px; }
.drawer-item { display: flex; align-items: center; gap: 12px; padding: 8px 10px; border-radius: 14px; border: 1px solid transparent; background: transparent; color: var(--text); font-size: 0.92rem; font-weight: 700; text-align: left; cursor: pointer; min-height: 52px; width: 100%; }
.drawer-item.active { background: var(--bg-input); border-color: var(--border-strong); color: var(--accent); }
.drawer-ico { width: 38px; height: 38px; border-radius: 12px; display: flex; align-items: center; justify-content: center; background: var(--bg-input); border: 1px solid var(--border); color: var(--text-muted); flex-shrink: 0; }
.drawer-item.active .drawer-ico { color: var(--accent); border-color: var(--accent); }
...
.ring-row { display: flex; gap: 16px; align-items: center; justify-content: space-around; flex-wrap: wrap; }
.ring-row > div { flex: 1 1 140px; min-width: min(100%, 140px); justify-content: center; }
...
/* Intro: Cover steht, zoomt in den Läufer (Mitte) und blendet aus. Nur GPU-Ebenen. */
.intro { position: fixed; top: 0; left: 0; right: 0; bottom: 0; z-index: 200; background: #000; pointer-events: none; }
.intro img { width: 100%; height: 100%; object-fit: cover; display: block; transform-origin: 50% 39%; will-change: transform, opacity; animation: introZoom 1.25s ease-out forwards; }
@keyframes introZoom { 0% { transform: scale(1); opacity: 1; } 70% { transform: scale(1.42); opacity: 1; } 100% { transform: scale(1.5); opacity: 0; } }
.intro-on .blob, .intro-on .bg-glow { display: none; }
`;